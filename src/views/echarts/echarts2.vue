...
export default {
  ...
  methods: {
    init() {
      ...
      for (var i = 0; i < that.trafficWay.length; i++) {
        data.push({
          value: that.trafficWay[i].value,
      ...
      let option = {
        ...
        graphic: {
          ...
          },
          {
            ...
            z: 3,
            style: {
              image: 'https://easyv.assets.dtstack.com/data/assets/rz8apazb6_1630499515299_vbic4cvaow.png',
              width: '94px',
              height: '94px',
            },
            left: 'center',
    ...
    uodateData(){
      ...
      this.timer = setInterval(() => {
        this.trafficWay = [{
          name: '火车',
          value: that.generateRandomNumber()
        }, {
          name: '飞机',
          value: that.generateRandomNumber()
        }, {
